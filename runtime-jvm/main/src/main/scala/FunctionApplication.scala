...
object FunctionApplication {
  ...
  def staticFullySaturatedCall(fn: Rt, args: Array[Rt], decompile: Term): Rt = {
      ...
      case 0 => (args.length: @switch) match {
        case 1 =>
          ...
          new Arity0(decompile) { def apply(r: R) = {
            eval0(arg0, r) // todo, possibly allocate fresh `R` for this?
      ...
      case n => (args.length: @switch) match {
        case 1 =>
          ...
          new ArityN(n, decompile) { def apply(args: Array[Slot], r: R) = {
            evalN(arg0, args, r) // todo, possibly allocate fresh `R` for this?
            fn(r.unboxed, r.boxed, r)
          }}
        case 2 =>
          val arg0 = args(0)
