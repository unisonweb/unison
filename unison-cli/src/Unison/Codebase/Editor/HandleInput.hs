    ...
    codebaseByMetadata = do
      ...
      case out of
        ...
        [(_name, ref, _tm)] -> do
          ...
          tm <- RuntimeUtils.evalUnisonTerm True (PPE.makePPE (PPE.hqNamer len names) PPE.dontSuffixify) True tm
...
suffixifiedPPE ns =
  Cli.runTransaction Codebase.hashLength <&> \hashLen -> PPE.makePPE (PPE.hqNamer hashLen ns) (PPE.suffixify ns)
