...
data Output
  ...
  | -- We can't do this operation because a namespace has this conflicted name
    NamespaceHasConflictedName !ConflictedName
  | -- We can't do this operation because a namespace has this conflicted name
    NamespaceHasIncoherentDecl !IncoherentDeclReason
...
isFailure o = case o of
  ...
  NamespaceHasConflictedName {} -> True
  NamespaceHasIncoherentDecl {} -> True
