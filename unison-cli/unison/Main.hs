            ...
            case e of
              ...
              Right contents -> do
                getCodebaseOrExit mCodePathOption SC.MigrateAutomatically \(initRes, _, theCodebase) -> do
                  ...
                  launch currentDir config rt sbrt theCodebase [Left fileEvent, Right $ Input.ExecuteI mainName args, Right Input.QuitI] Nothing ShouldNotDownloadBase initRes noOpRootNotifier noOpPathNotifier
              ...
              DoNotExit -> do
                case isHeadless of
                  ...
                  WithCLI -> do
                    ...
                    launch currentDir config runtime sbRuntime theCodebase [] (Just baseUrl) downloadBase initRes notifyOnRootChanges notifyOnPathChanges
...
launch ::
  ...
  (Path.Absolute -> STM ()) ->
  IO ()
launch dir config runtime sbRuntime codebase inputs serverBaseUrl shouldDownloadBase initResult notifyRootChange notifyPathChange =
