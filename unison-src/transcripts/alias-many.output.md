...
.builtin> find
  ...
  279. io2.MVar.put.impl : MVar a -> a ->{IO} Either Failure ()
  280. io2.MVar.read.impl : MVar a ->{IO} Either Failure a
  281. io2.MVar.swap.impl : MVar a -> a ->{IO} Either Failure a
  282. io2.MVar.take.impl : MVar a ->{IO} Either Failure a
