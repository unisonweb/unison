...
scratch/main> reflog
  ...
  1.   scratch/main   #6i8fihs6u1   update
  2.   scratch/main   #8rrlhobds4   update
  3.   scratch/main   #es8qksqb4e   builtins.merge scratch/main:lib.builtins
...
scratch/main> project.reflog
  ...
  Tip: Use `diff.namespace 1 7` to compare between points in
       ...
       Branch          Hash          Description
  1.   scratch/other   #3fqaprdf53   alias.term y scratch/other:z
  2.   scratch/other   #6i8fihs6u1   Branch created from scratch/main
  3.   scratch/main    #6i8fihs6u1   update
  4.   scratch/main    #8rrlhobds4   update
  5.   scratch/main    #es8qksqb4e   builtins.merge scratch/main:lib.builtins
...
scratch/main> reflog.global
  ...
  Tip: Use `diff.namespace 1 7` to compare between points in
       ...
       Branch            Hash          Description
  1.   newproject/main   #mptank8k4e   alias.type lib.builtins.Nat .MyNat
  2.   newproject/main   #es8qksqb4e   builtins.merge newproject/main:lib.builtins
  3.   newproject/main   #sg60bvjo91   Branch Created
  4.   scratch/other     #3fqaprdf53   alias.term y scratch/other:z
  5.   scratch/other     #6i8fihs6u1   Branch created from scratch/main
  6.   scratch/main      #6i8fihs6u1   update
  7.   scratch/main      #8rrlhobds4   update
  8.   scratch/main      #es8qksqb4e   builtins.merge scratch/main:lib.builtins
