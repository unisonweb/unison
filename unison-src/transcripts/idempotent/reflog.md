...
scratch/main> reflog
  ...
  1.   scratch/main   #17let93j24   update
  2.   scratch/main   #v1scv1rre4   update
  3.   scratch/main   #8n2ot0bdfa   builtins.merge scratch/main:lib.builtins
...
scratch/main> project.reflog
  ...
  Tip: Use `diff.namespace 1 7` to compare between points in
       ...
       Branch          Hash          Description
  1.   scratch/other   #g5a31abgsp   alias.term y scratch/other:z
  2.   scratch/other   #17let93j24   Branch created from scratch/main
  3.   scratch/main    #17let93j24   update
  4.   scratch/main    #v1scv1rre4   update
  5.   scratch/main    #8n2ot0bdfa   builtins.merge scratch/main:lib.builtins
...
scratch/main> reflog.global
  ...
  Tip: Use `diff.namespace 1 7` to compare between points in
       ...
       Branch            Hash          Description
  1.   newproject/main   #0khclbl8p1   alias.term lib.builtins.Nat newproject/main:MyNat
  2.   newproject/main   #8n2ot0bdfa   builtins.merge newproject/main:lib.builtins
  3.   newproject/main   #sg60bvjo91   Branch Created
  4.   scratch/other     #g5a31abgsp   alias.term y scratch/other:z
  5.   scratch/other     #17let93j24   Branch created from scratch/main
  6.   scratch/main      #17let93j24   update
  7.   scratch/main      #v1scv1rre4   update
  8.   scratch/main      #8n2ot0bdfa   builtins.merge scratch/main:lib.builtins
