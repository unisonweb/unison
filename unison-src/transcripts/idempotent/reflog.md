...
scratch/main> reflog
  ...
  1.   scratch/main   #rmags5fceb   update
  2.   scratch/main   #b2htoc8abl   update
  3.   scratch/main   #0i4kioqjun   builtins.merge scratch/main:lib.builtins
...
scratch/main> project.reflog
  ...
  Tip: Use `diff.namespace 1 7` to compare between points in
       ...
       Branch          Hash          Description
  1.   scratch/other   #iqi3nfrsls   alias.term y scratch/other:z
  2.   scratch/other   #rmags5fceb   Branch created from scratch/main
  3.   scratch/main    #rmags5fceb   update
  4.   scratch/main    #b2htoc8abl   update
  5.   scratch/main    #0i4kioqjun   builtins.merge scratch/main:lib.builtins
...
scratch/main> reflog.global
  ...
  Tip: Use `diff.namespace 1 7` to compare between points in
       ...
       Branch            Hash          Description
  1.   newproject/main   #cvhi9cmfh9   alias.type lib.builtins.Nat .MyNat
  2.   newproject/main   #0i4kioqjun   builtins.merge newproject/main:lib.builtins
  3.   newproject/main   #sg60bvjo91   Branch Created
  4.   scratch/other     #iqi3nfrsls   alias.term y scratch/other:z
  5.   scratch/other     #rmags5fceb   Branch created from scratch/main
  6.   scratch/main      #rmags5fceb   update
  7.   scratch/main      #b2htoc8abl   update
  8.   scratch/main      #0i4kioqjun   builtins.merge scratch/main:lib.builtins
