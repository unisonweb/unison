...
scratch/main> reflog
  ...
  1.   scratch/main   #jff7gat29m   update
  2.   scratch/main   #g99qkjiojt   update
  3.   scratch/main   #k3onshm4j5   builtins.merge scratch/main:lib.builtins
...
scratch/main> project.reflog
  ...
  Tip: Use `diff.namespace 1 7` to compare between points in
       ...
       Branch          Hash          Description
  1.   scratch/other   #fdug50a8d0   alias.term y scratch/other:z
  2.   scratch/other   #jff7gat29m   Branch created from scratch/main
  3.   scratch/main    #jff7gat29m   update
  4.   scratch/main    #g99qkjiojt   update
  5.   scratch/main    #k3onshm4j5   builtins.merge scratch/main:lib.builtins
...
scratch/main> reflog.global
  ...
  Tip: Use `diff.namespace 1 7` to compare between points in
       ...
       Branch            Hash          Description
  1.   newproject/main   #3olqqu90vf   alias.term lib.builtins.Nat newproject/main:MyNat
  2.   newproject/main   #k3onshm4j5   builtins.merge newproject/main:lib.builtins
  3.   newproject/main   #sg60bvjo91   Branch Created
  4.   scratch/other     #fdug50a8d0   alias.term y scratch/other:z
  5.   scratch/other     #jff7gat29m   Branch created from scratch/main
  6.   scratch/main      #jff7gat29m   update
  7.   scratch/main      #g99qkjiojt   update
  8.   scratch/main      #k3onshm4j5   builtins.merge scratch/main:lib.builtins
