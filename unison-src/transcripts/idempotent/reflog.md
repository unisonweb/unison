...
scratch/main> reflog
  ...
  1.   scratch/main   #3bit5muu38   update
  2.   scratch/main   #6e7u7ke6jl   update
  3.   scratch/main   #o881hi3l7q   builtins.merge scratch/main:lib.builtins
...
scratch/main> project.reflog
  ...
  Tip: Use `diff.namespace 1 7` to compare between points in
       ...
       Branch          Hash          Description
  1.   scratch/other   #p7l574qk8l   alias.term y scratch/other:z
  2.   scratch/other   #3bit5muu38   Branch created from scratch/main
  3.   scratch/main    #3bit5muu38   update
  4.   scratch/main    #6e7u7ke6jl   update
  5.   scratch/main    #o881hi3l7q   builtins.merge scratch/main:lib.builtins
...
scratch/main> reflog.global
  ...
  Tip: Use `diff.namespace 1 7` to compare between points in
       ...
       Branch            Hash          Description
  1.   newproject/main   #smhb42ltrm   alias.term lib.builtins.Nat newproject/main:MyNat
  2.   newproject/main   #o881hi3l7q   builtins.merge newproject/main:lib.builtins
  3.   newproject/main   #sg60bvjo91   Branch Created
  4.   scratch/other     #p7l574qk8l   alias.term y scratch/other:z
  5.   scratch/other     #3bit5muu38   Branch created from scratch/main
  6.   scratch/main      #3bit5muu38   update
  7.   scratch/main      #6e7u7ke6jl   update
  8.   scratch/main      #o881hi3l7q   builtins.merge scratch/main:lib.builtins
