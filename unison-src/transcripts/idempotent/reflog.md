...
scratch/main> reflog
  ...
  1.   scratch/main   #f604mi4o1k   update
  2.   scratch/main   #34vcs4atjh   update
  3.   scratch/main   #4ivsfim1t0   builtins.merge scratch/main:lib.builtins
...
scratch/main> project.reflog
  ...
  Tip: Use `diff.namespace 1 7` to compare between points in
       ...
       Branch          Hash          Description
  1.   scratch/other   #8j1moovcer   alias.term y scratch/other:z
  2.   scratch/other   #f604mi4o1k   Branch created from scratch/main
  3.   scratch/main    #f604mi4o1k   update
  4.   scratch/main    #34vcs4atjh   update
  5.   scratch/main    #4ivsfim1t0   builtins.merge scratch/main:lib.builtins
...
scratch/main> reflog.global
  ...
  Tip: Use `diff.namespace 1 7` to compare between points in
       ...
       Branch            Hash          Description
  1.   newproject/main   #mkhfuhchpp   alias.type lib.builtins.Nat .MyNat
  2.   newproject/main   #4ivsfim1t0   builtins.merge newproject/main:lib.builtins
  3.   newproject/main   #sg60bvjo91   Branch Created
  4.   scratch/other     #8j1moovcer   alias.term y scratch/other:z
  5.   scratch/other     #f604mi4o1k   Branch created from scratch/main
  6.   scratch/main      #f604mi4o1k   update
  7.   scratch/main      #34vcs4atjh   update
  8.   scratch/main      #4ivsfim1t0   builtins.merge scratch/main:lib.builtins
