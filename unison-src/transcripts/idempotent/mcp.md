...
RESPONSE:
  {
      ...
      "result": {
          "content": [
              {
                  "text": "{\"errorMessages\":[],\"outputMessages\":[\"     Branch   Remote branch\\n1.   main     \"],\"sourceCodeUpdates\":[],\"stderr\":\"\",\"stdout\":\"InputPattern: 1.73 ms (cpu), 2.15 ms (system)\\n\"}",
                  "type": "text"
              }
          ],
          "isError": false
...
RESPONSE:
  {
      ...
      "result": {
          "content": [
              {
                  "text": "{\"errorMessages\":[],\"outputMessages\":[\"Loading changes detected in <mcp-virtual-source>.\",\"No changes found.\",\"  1 | > x = 1 + 2\\n        â§©\\n        3\"],\"sourceCodeUpdates\":[],\"stderr\":\"\",\"stdout\":\"evaluating watches: 6.24 ms (cpu), 6.59 ms (system)\\nUnisonFileChanged: 47.6 ms (cpu), 37.0 ms (system)\\n\"}",
                  "type": "text"
              }
          ],
          "isError": false
...
RESPONSE:
  {
      ...
      "result": {
          "content": [
              {
                  "text": "{\"errorMessages\":[],\"outputMessages\":[\"Some \\\"hello\\\"\"],\"sourceCodeUpdates\":[],\"stderr\":\"\",\"stdout\":\"helloInputPattern: 24.1 ms (cpu), 26.1 ms (system)\\n\"}",
                  "type": "text"
              }
          ],
          "isError": false
...
RESPONSE:
  {
      ...
      "result": {
          "content": [
              {
                  "text": "{\"errorMessages\":[],\"outputMessages\":[\"1. builtins. (1012 terms, 150 types)\"],\"sourceCodeUpdates\":[],\"stderr\":\"\",\"stdout\":\"InputPattern: 6.03 ms (cpu), 6.88 ms (system)\\n\"}",
                  "type": "text"
              }
          ],
          "isError": false
...
RESPONSE:
  {
      ...
      "result": {
          "content": [
              {
                  "text": "{\"errorMessages\":[],\"outputMessages\":[\"     Branch   Remote branch\\n1.   main     \"],\"sourceCodeUpdates\":[],\"stderr\":\"\",\"stdout\":\"InputPattern: 1.86 ms (cpu), 2.62 ms (system)\\n\"}",
                  "type": "text"
              }
          ],
          "isError": false
...
RESPONSE:
  {
      ...
      "result": {
          "content": [
              {
                  "text": "{\"errorMessages\":[],\"outputMessages\":[\"type MyType = MyConstructor\\n\\nmyTerm : Nat\\nmyTerm = 99\"],\"sourceCodeUpdates\":[],\"stderr\":\"\",\"stdout\":\"InputPattern: 8.30 ms (cpu), 8.90 ms (system)\\n\"}",
                  "type": "text"
              }
          ],
          "isError": false
...
RESPONSE:
  {
      ...
      "result": {
          "content": [
              {
                  "text": "{\"errorMessages\":[],\"outputMessages\":[\"1. myTerm : Nat\\n\"],\"sourceCodeUpdates\":[],\"stderr\":\"\",\"stdout\":\"InputPattern: 8.02 ms (cpu), 8.44 ms (system)\\n\"}",
                  "type": "text"
              }
          ],
          "isError": false
...
RESPONSE:
  {
      ...
      "result": {
          "content": [
              {
                  "text": "{\"errorMessages\":[],\"outputMessages\":[\"Loading changes detected in <mcp-virtual-source>.\",\"+ myTerm : Nat\\n\\nRun `update` to apply these changes to your codebase.\",\"Done.\"],\"sourceCodeUpdates\":[],\"stderr\":\"\",\"stdout\":\"UnisonFileChanged: 17.9 ms (cpu), 18.6 ms (system)\\nupdateProjectBranchRoot: 3.38 ms (cpu), 3.65 ms (system)\\nInputPattern: 9.79 ms (cpu), 10.5 ms (system)\\n\"}",
                  "type": "text"
              }
          ],
          "isError": false
...
RESPONSE:
  {
      ...
      "result": {
          "content": [
              {
                  "text": "{\"errorMessages\":[],\"outputMessages\":[\"Renamed:\\n\\n  termToRename -> renamedTerm\"],\"sourceCodeUpdates\":[],\"stderr\":\"\",\"stdout\":\"updateProjectBranchRoot: 3.31 ms (cpu), 3.52 ms (system)\\nInputPattern: 15.2 ms (cpu), 16.2 ms (system)\\n\"}",
                  "type": "text"
              }
          ],
          "isError": false
...
RESPONSE:
  {
      ...
      "result": {
          "content": [
              {
                  "text": "{\"errorMessages\":[],\"outputMessages\":[\"Done.\"],\"sourceCodeUpdates\":[],\"stderr\":\"\",\"stdout\":\"updateProjectBranchRoot: 3.80 ms (cpu), 4.00 ms (system)\\nInputPattern: 16.4 ms (cpu), 18.8 ms (system)\\n\"}",
                  "type": "text"
              }
          ],
          "isError": false
...
RESPONSE:
  {
      ...
      "result": {
          "content": [
              {
                  "text": "{\"errorMessages\":[],\"outputMessages\":[\"Moved:\\n\\n  source.termA -> dest.termA\\n  source.termB -> dest.termB\"],\"sourceCodeUpdates\":[],\"stderr\":\"\",\"stdout\":\"updateProjectBranchRoot: 3.64 ms (cpu), 3.86 ms (system)\\nInputPattern: 26.4 ms (cpu), 28.9 ms (system)\\n\"}",
                  "type": "text"
              }
          ],
          "isError": false
...
RESPONSE:
  {
      ...
      "result": {
          "content": [
              {
                  "text": "{\"errorMessages\":[],\"outputMessages\":[\"I deleted these terms:\\n\\n  1. termToDelete\\n\\nTip: You can use `undo` or use a hash from `reflog` to undo this change.\"],\"sourceCodeUpdates\":[],\"stderr\":\"\",\"stdout\":\"updateProjectBranchRoot: 3.50 ms (cpu), 4.27 ms (system)\\nInputPattern: 9.10 ms (cpu), 10.4 ms (system)\\n\"}",
                  "type": "text"
              }
          ],
          "isError": false
...
RESPONSE:
  {
      ...
      "result": {
          "content": [
              {
                  "text": "{\"errorMessages\":[],\"outputMessages\":[\"Done.\"],\"sourceCodeUpdates\":[],\"stderr\":\"\",\"stdout\":\"updateProjectBranchRoot: 3.34 ms (cpu), 3.67 ms (system)\\nInputPattern: 11.7 ms (cpu), 13.6 ms (system)\\n\"}",
                  "type": "text"
              }
          ],
          "isError": false
...
RESPONSE:
  {
      ...
      "result": {
          "content": [
              {
                  "text": "{\"entries\":[{\"branch\":\"reflog-test\",\"fromHash\":\"#3piccfkvc3\",\"project\":\"scratch\",\"reason\":\"update\",\"toHash\":\"#vj6gp6rhut\"},{\"branch\":\"reflog-test\",\"fromHash\":\"#sg60bvjo91\",\"project\":\"scratch\",\"reason\":\"builtins.merge scratch/reflog-test:lib.builtins\",\"toHash\":\"#3piccfkvc3\"},{\"branch\":\"reflog-test\",\"fromHash\":null,\"project\":\"scratch\",\"reason\":\"Branch Created\",\"toHash\":\"#sg60bvjo91\"}],\"hasMore\":false}",
                  "type": "text"
              }
          ],
          "isError": false
...
RESPONSE:
  {
      ...
      "result": {
          "content": [
              {
                  "text": "{\"errorMessages\":[],\"outputMessages\":[\"Note: The most recent namespace hash is immediately below this message.\\n\\nâ 1. #vj6gp6rhut\\n\\n  + Adds / updates:\\n  \\n    reflogTestTerm\\n\\nâ¡ 2. #3piccfkvc3 (start of history)\"],\"sourceCodeUpdates\":[],\"stderr\":\"\",\"stdout\":\"InputPattern: 6.12 ms (cpu), 6.47 ms (system)\\n\"}",
                  "type": "text"
              }
          ],
          "isError": false
...
RESPONSE:
  {
      ...
      "result": {
          "content": [
              {
                  "text": "{\"errorMessages\":[],\"outputMessages\":[\"Done. I've created the from-current branch based off of reflog-test.\\n\\nTip: To merge your work back into the reflog-test branch, first `switch /reflog-test` then `merge /from-current`.\"],\"sourceCodeUpdates\":[],\"stderr\":\"\",\"stdout\":\"InputPattern: 5.90 ms (cpu), 6.63 ms (system)\\n\"}",
                  "type": "text"
              }
          ],
          "isError": false
...
RESPONSE:
  {
      ...
      "result": {
          "content": [
              {
                  "text": "{\"errorMessages\":[],\"outputMessages\":[\"Done. I've created an empty branch scratch/empty-branch.\\n\\nTip: Use `merge /somebranch` to initialize this branch.\"],\"sourceCodeUpdates\":[],\"stderr\":\"\",\"stdout\":\"InputPattern: 5.22 ms (cpu), 6.45 ms (system)\\n\"}",
                  "type": "text"
              }
          ],
          "isError": false
