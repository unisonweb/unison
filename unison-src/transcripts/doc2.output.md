...
fulldoc =
  ...
  {{
    ...
    Here's a cool **BOLD** __italic__ ~~strikethrough~~ thing with an inline
    code block ''1 + 2''
      ...
      ## Heading 2
         ...
         * List item
         ...
         Special
           (Embed
             (Any
               (Video [MediaSource "test.mp4" None] [("poster", "test.png")])))
         }}
         ...
         The following markdown features aren't supported by the Doc format
         yet, but maybe will someday
