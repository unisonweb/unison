...
.> display 1
  ...
  List.take.ex1 = builtin.List.take 0 [1, 2, 3, 4, 5] 🔽 ex1 = []
  
  
  List.take.ex2 = builtin.List.take 2 [1, 2, 3, 4, 5] 🔽 ex2 = [ 1,
    2 ]
...
.> view docs.List.take
  ...
  docs.List.take =
    ...
    @[source] ex1 🔽 @ex1 = @[evaluate] ex1
    
    
    @[source] ex2 🔽 @ex2 = @[evaluate] ex2
    :]
