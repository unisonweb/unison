...
```ucm
.> display d1
.> docs importantFunction
```

The `docs foo` command will look for `foo.doc` in the file or codebase. You can do this instead of explicitly linking docs to definitions.
