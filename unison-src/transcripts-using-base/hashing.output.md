...
> ls builtin.Bytes
  ...
  1.  ++                    (Bytes -> Bytes -> Bytes)
  2.  OutOfBounds           (type)
  3.  at                    (Nat -> Bytes -> Optional Nat)
  4.  decodeNat16be         (Bytes -> Optional (Nat, Bytes))
  5.  decodeNat16le         (Bytes -> Optional (Nat, Bytes))
  6.  decodeNat32be         (Bytes -> Optional (Nat, Bytes))
  7.  decodeNat32le         (Bytes -> Optional (Nat, Bytes))
  8.  decodeNat64be         (Bytes -> Optional (Nat, Bytes))
  9.  decodeNat64le         (Bytes -> Optional (Nat, Bytes))
  10. drop                  (Nat -> Bytes -> Bytes)
  11. empty                 (Bytes)
  12. encodeNat16be         (Nat -> Bytes)
  13. encodeNat16le         (Nat -> Bytes)
  14. encodeNat32be         (Nat -> Bytes)
  15. encodeNat32le         (Nat -> Bytes)
  16. encodeNat64be         (Nat -> Bytes)
  17. encodeNat64le         (Nat -> Bytes)
  18. flatten               (Bytes -> Bytes)
  19. fromBase16            (Bytes -> Either Text Bytes)
  20. fromBase32            (Bytes -> Either Text Bytes)
  21. fromBase64            (Bytes -> Either Text Bytes)
  22. fromBase64UrlUnpadded (Bytes -> Either Text Bytes)
  23. fromList              ([Nat] -> Bytes)
  24. gzip.                 (2 terms)
  25. indexOf               (Bytes -> Bytes -> Optional Nat)
  26. size                  (Bytes -> Nat)
  27. take                  (Nat -> Bytes -> Bytes)
  28. toBase16              (Bytes -> Bytes)
  29. toBase32              (Bytes -> Bytes)
  30. toBase64              (Bytes -> Bytes)
  31. toBase64UrlUnpadded   (Bytes -> Bytes)
  32. toList                (Bytes -> [Nat])
  33. zlib.                 (2 terms)
  34. zstd.                 (2 terms)
```
