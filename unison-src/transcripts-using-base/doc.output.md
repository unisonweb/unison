    ...
    {{
      # Basic formatting
        ...
        * [A named type link]({type Optional}) and
        ...
        is useful for creating documents programmatically or
        just including other documents.
    ...
    {{
      # Lists
        ...
        ## Bulleted lists
           ...
           the pretty-printer). They can be nested, to any
           depth:
  ...
  includingSource =
    ...
    {{
      # Including Unison source code
        ...
        Unison definitions can be included in docs. For
        instance:
        ...
        ## Inline snippets
           ...
           * {{ docExample 2 '(f x -> f x + sqr 1) }} - the
             ''2'' says to ignore the first two arguments when
             rendering. In richer renderers, the ''sqr'' link
             will be clickable.
           * If your snippet expression is just a single
             function application, you can put it in double
             backticks, like so: ``sqr x``. This is equivalent
             to {{ docExample 1 '(x -> sqr x) }}.
    }}
      ...
      docTable
        [ [ {{
          ...
          , {{
              ...
              lines, such that this row occupies multiple lines
