...
module Unison.Hashing.V1.LabeledDependency
  ( derivedTerm
  , derivedType
  , termRef
  , typeRef
...
import Unison.Hashing.V1.Reference (Id, Reference (DerivedId))
import Unison.Hashing.V1.Referent (ConstructorId, Referent, pattern Con, pattern Ref)
