...
module Unison.Hashing.V1.Term where
...
import           Unison.Hashing.V1.Reference (Reference, pattern Builtin)
...
import qualified Unison.Hashing.V1.Referent as Referent
...
import qualified Unison.Hashing.V1.LabeledDependency as LD
import Unison.Hashing.V1.LabeledDependency (LabeledDependency)
...
unhashComponent m = let
  ...
  m' = evalState (Map.traverseWithKey assignVar m) usedVars where
    assignVar r t = (,t) <$> ABT.freshenS (refNamed r)
