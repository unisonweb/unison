...
fromNames0 :: Monad m => Names0 -> m (Branch m)
...
hashesFromNames0 :: Monad m => Names0 -> m (Map Branch.Hash (Branch m))
hashesFromNames0 = fmap deepHashes . fromNames0 where
...
addFromNames0 :: Monad m => Names0 -> Branch0 m -> m (Branch0 m)
