        ...
        let codebase =
              C.Codebase
                { getTerm =
                  ...
                  getOpaqueDeclaration = CodebaseOps.getOpaqueDeclaration,
                  isOpaqueDeclaration = CodebaseOps.isOpaqueDeclaration,
                  getDeclType,
                  expectDeclNumConstructors,
                  ...
                  putOpaqueDeclaration = CodebaseOps.putOpaqueDeclaration,
                  getTermComponentWithTypes,
                  getBranchForHash,
                  getBranchForHashTx,
