...
module Unison.Codebase.FileCodebase.Term where
...
import           Unison.Codebase.FileCodebase.Pattern (Pattern)
import qualified Unison.Codebase.FileCodebase.Pattern as Pattern
import           Unison.Codebase.FileCodebase.Reference (Reference, pattern Builtin)
