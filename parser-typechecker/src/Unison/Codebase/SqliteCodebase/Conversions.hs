...
referenceid2toshorthash1 :: V2.Reference.Id' Hash -> ShortHash.ShortHash
referenceid2toshorthash1 = \case
  V2.Reference.Id h i -> ShortHash.ShortHash (Hash.toBase32HexText h) (showComponentPos i) Nothing
  where
