...
ioBuiltins =
  [ ("IO.openFile.impl.v3", text --> fmode --> iof handle),
    ...
    ("IO.UDP.UDPSocket.port.impl.v1", udpSocket --> iof nat),
    ...
    ("IO.UDP.ListenSocket.accept.impl.v1", udpListenSocket --> udpClientSockAddr --> iof udpSocket),
    ("IO.UDP.ListenSocket.toText.impl.v1", udpListenSocket --> text),
    ("IO.UDP.ListenSocket.close.impl.v1", udpListenSocket --> iof unit),
    ("IO.UDP.ListenSocket.port.impl.v1", udpListenSocket --> iof nat),
    ("IO.UDP.recv.impl.v1", udpSocket --> iof bytes),
    ("IO.UDP.send.impl.v1", udpSocket --> bytes --> iof unit),
