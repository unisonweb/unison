...
ioBuiltins =
  [ ("IO.openFile.impl.v3", text --> fmode --> iof handle),
    ...
    ("Tls.ServerConfig.certificates.get", tlsClientConfig --> list tlsSignedCert),
    ("Tls.ClientConfig.validate.disableHostNameValidation", tlsClientConfig --> tlsClientConfig),
    ("Tls.ClientConfig.validate.disableCertificateValidation", tlsClientConfig --> tlsClientConfig),
