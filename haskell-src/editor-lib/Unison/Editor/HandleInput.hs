...
module Unison.Editor.HandleInput
  ( loop
  , loopState0
  , LoopState(..)
  , currentPath
...
import Unison.Editor.MainTerm ( nullaryMain, mainTypes, getMainTerm )
import qualified Unison.Editor.MainTerm as MainTerm
import Unison.Editor.Command
import Unison.Editor.Input
import Unison.Editor.Output
import Unison.Editor.DisplayThing
import qualified Unison.Editor.Output as Output
import Unison.Editor.SlurpResult (SlurpResult(..))
import qualified Unison.Editor.SlurpResult as Slurp
import Unison.Editor.SlurpComponent (SlurpComponent(..))
import qualified Unison.Editor.SlurpComponent as SC
import Unison.Editor.Data.RemoteRepo (RemoteNamespace, printNamespace)
import qualified Unison.CLI.InputPattern as InputPattern
import qualified Unison.CLI.InputPatterns as InputPatterns
...
import qualified Unison.Editor.Output.BranchDiff as OBranchDiff
...
import           Unison.Codebase.Data.SearchResult   ( SearchResult )
import qualified Unison.Codebase.Data.SearchResult  as SR
import qualified Unison.Codebase.Data.ShortBranchHash as SBH
import qualified Unison.Codebase.SyncMode      as SyncMode
import qualified Unison.Runtime.Builtin.Decls          as DD
import qualified Unison.DataDeclaration        as DD
import qualified Unison.HashQualified          as HQ
import qualified Unison.HashQualified'         as HQ'
import qualified Unison.Codebase.Data.Name                   as Name
import           Unison.Codebase.Data.Name                    ( Name )
import           Unison.Editor.Data.Names3                  ( Names(..), Names0
                                                , pattern Names0 )
import qualified Unison.Editor.Data.Names2                 as Names
import qualified Unison.Editor.Data.Names3                 as Names3
...
import qualified Unison.Codebase.Data.ShortHash as SH
...
import           Unison.Util.Data.List               ( uniqueBy )
import qualified Unison.Util.Data.Relation          as R
import qualified Unison.Util.Data.Relation4          as R4
...
import qualified Unison.Printer.Data.PrettyPrintEnv as PPE
import           Unison.Runtime.IOSource       ( isTest )
import qualified Unison.Runtime.IOSource as IOSource
import qualified Unison.Util.Data.Star3             as Star3
import qualified Unison.Pretty            as P
import qualified Unison.Util.Data.Monoid            as Monoid
import Unison.UnisonFile (TypecheckedUnisonFile)
import qualified Unison.Editor.TodoOutput as TO
import qualified Unison.Parser.Lexer as L
import Unison.Editor.SearchResult' (SearchResult')
import qualified Unison.Editor.SearchResult' as SR'
import qualified Unison.LabeledDependency as LD
import Unison.LabeledDependency (LabeledDependency)
import Unison.Term (Term)
import Unison.Type (Type)
import qualified Unison.Runtime.Builtin as Builtin
import Unison.Codebase.NameSegment (NameSegment(..))
import qualified Unison.Codebase.NameSegment as NameSegment
import Unison.Codebase.Data.ShortBranchHash (ShortBranchHash)
import qualified Unison.Editor.Propagate as Propagate
import qualified Unison.Editor.Data.UriParser as UriParser
import Data.Tuple.Extra (uncurry3)
import qualified Unison.Printer.DisplayValues as DisplayValues
import qualified Control.Error.Util as ErrorUtil
import Unison.Util.Data.Monoid (intercalateMap)
import Data.List.NonEmpty (NonEmpty)
import qualified Data.List.NonEmpty as Nel
import Unison.Editor.AuthorInfo (AuthorInfo(..))
    ...
    Right input ->
      let
        ...
        inputDescription = case input of
          ...
          ps' = p' . Path.unsplit'
        stepAt = Unison.Editor.HandleInput.stepAt inputDescription
        stepManyAt = Unison.Editor.HandleInput.stepManyAt inputDescription
        stepManyAtNoSync =
          Unison.Editor.HandleInput.stepManyAtNoSync
        updateRoot = flip Unison.Editor.HandleInput.updateRoot inputDescription
        syncRoot = use root >>= updateRoot
        updateAtM = Unison.Editor.HandleInput.updateAtM inputDescription
