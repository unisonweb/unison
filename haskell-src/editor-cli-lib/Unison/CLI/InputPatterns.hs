...
module Unison.CLI.InputPatterns where
...
import Unison.Editor.Input (Input)
import qualified Unison.Codebase.SyncMode as SyncMode
import Unison.CLI.InputPattern
         ( ArgumentType(..)
...
import qualified Unison.CLI.InputPattern as I
...
import Unison.Editor.Data.RemoteRepo (RemoteNamespace)
