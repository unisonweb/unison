...
import qualified Unison.Editor.Git.GitError      as GitError
import           Unison.Editor.Git.GitError       (GitError)
import qualified Unison.Codebase               as Codebase
import           Unison.Codebase                (Codebase, CodebasePath)
import           Unison.Editor.Data.RemoteRepo ( RemoteRepo(GitRepo)
                                                   , RemoteNamespace
                                                   , printRepo
                                                   )
