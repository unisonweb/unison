...
module Unison.Printer.Data.ColorText (
  ...
  module Unison.Pretty.AnnotatedText)
where

import Unison.Prelude

import qualified System.Console.ANSI       as ANSI
import           Unison.Pretty.AnnotatedText (AnnotatedText(..), annotate)
import qualified Unison.Printer.Data.SyntaxText    as ST hiding (toPlain)
