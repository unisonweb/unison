...
module Unison.Typechecker.PrintError where
...
import Unison.Runtime.Builtin.Decls                   (pattern TupleType')
...
import           Unison.Pretty.AnnotatedText    (AnnotatedText)
import qualified Unison.Pretty.AnnotatedText    as AT
import           Unison.Pretty.ColorText        (Color)
import qualified Unison.Pretty.ColorText        as Color
import           Unison.Util.Data.Monoid           (intercalateMap)
import           Unison.Parser.Range            (Range (..), startingLine)
import           Unison.Var                   (Var)
import qualified Unison.Var                   as Var
import qualified Unison.Printer.Data.PrettyPrintEnv as PPE
import qualified Unison.TermPrinter as TermPrinter
import qualified Unison.Pretty as Pr
...
import Unison.Printer.NamePrinter (prettyHashQualified0)
