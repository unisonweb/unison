...
module Unison.Printer.TypePrinter where
...
import           Unison.Printer.Data.PrettyPrintEnv (PrettyPrintEnv, Imports, elideFQN)
import qualified Unison.Printer.Data.PrettyPrintEnv as PrettyPrintEnv
import           Unison.Reference      (pattern Builtin)
import           Unison.Type
import           Unison.Pretty    (ColorText, Pretty)
import           Unison.Pretty.ColorText (toPlain)
