...
module Unison.Printer.TermPrinter where
...
import           Unison.Parser.Lexer                   ( symbolyId, showEscapeChar )
import           Unison.Codebase.Data.Name                    ( Name )
import qualified Unison.Codebase.Data.Name                   as Name
import qualified Unison.Codebase.NameSegment            as NameSegment
import           Unison.Printer.NamePrinter             ( styleHashQualified'' )
import qualified Unison.Pattern                as Pattern
import           Unison.PatternP                ( Pattern )
import qualified Unison.PatternP               as PatternP
import           Unison.Reference               ( Reference )
import qualified Unison.Referent               as Referent
import qualified Unison.Printer.SyntaxText        as S
import           Unison.Printer.SyntaxText         ( SyntaxText )
import           Unison.Term
...
import qualified Unison.Pretty             as PP
import           Unison.Pretty             ( Pretty, ColorText )
import           Unison.Printer.Data.PrettyPrintEnv          ( PrettyPrintEnv, Suffix, Prefix, Imports, elideFQN )
import qualified Unison.Printer.Data.PrettyPrintEnv         as PrettyPrintEnv
import qualified Unison.Runtime.Builtin.Decls          as DD
import Unison.Runtime.Builtin.Decls (pattern TuplePattern, pattern TupleTerm')
