...
import           Unison.Runtime.API.Runtime          ( Runtime, evaluateWatches )
...
import qualified Unison.Editor.Data.Names3
...
type SynthResult =
  Result (Seq Note)
         (Either Unison.Editor.Data.Names3.Names0 TFile)
...
decodeResult source (Result notes (Just (Left errNames))) =
  Left $ showNotes
          ...
          (PPE.fromNames Common.hqLength
            (Unison.Editor.Data.Names3.shadowing errNames Builtin.names))
          notes
