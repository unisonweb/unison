...
pattern ConReference :: ConstructorReferenceId -> ConstructorType -> LabeledDependency
...
pattern DataConstructor, EffectConstructor :: ConstructorReferenceId -> LabeledDependency
...
dataConstructor :: ConstructorReferenceId -> LabeledDependency
dataConstructor r = ConReference r Data

effectConstructor :: ConstructorReferenceId -> LabeledDependency
