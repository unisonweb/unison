...
pinnedArrayRef :: TypeReference
pinnedArrayRef = Reference.Builtin "PinnedArray"
...
iarrayType, marrayType, ibytearrayType, mbytearrayType, pinnedArrayType :: (Ord v) => a -> Type v a
...
pinnedArrayType a = ref a pinnedArrayRef
