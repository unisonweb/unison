  ...
  showsPrec = go
    where
      ...
      go _ (Blank b) = case b of
        ...
        -- An unresolved implicit-argument hole. Printed like a
        -- generic blank; the elaborator substitutes the resolved
        -- dictionary term before this ever needs a richer rendering.
