...
-- to the same set of references as `fqn`. Uses an efficient logarithmic lookup
-- in the provided relation. The returned `Name` may refer to multiple hashes if
